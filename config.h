...
static const char *fonts[] = {
    "Fira Code Nerd Font:size=16", "JoyPixels:pixelsize=14:antialias=true:autohint=true"};
...
static const char *colors[][3] = {
    ...
    [SchemeTagsSel] = {col_gray2, col_blue,
...
static Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
            TAGKEYS(XK_9, 8){
                MODKEY, XK_F2, spawn,
                SHCMD("screenkey -s small --scr 1 -p fixed -g "
                      "600x100+2573+1330 --opacity .9 --font-color white")},
